...
class TrainerBase():
    ...
    def get_saving_file_name(self):
        ...
        # best_test_stats = self.all_valid_stats[self.best_epoch - 1]
    ...
    def save_stats(self):
        ...
        save(stats, os.path.join(self.saving_path, 'stats/test', self.get_saving_file_name()))
    ...
    def save_model(self):
        torch.save(self.best_model, os.path.join(self.saving_path, 'models/test', self.get_saving_file_name()))
